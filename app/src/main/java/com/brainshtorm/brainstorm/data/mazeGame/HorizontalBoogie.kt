...
class HorizontalBoogie : IGameMaze {
    ...
    override fun generateFigure(): ArrayList<TapButton> {
        ...
        val rowPositionFirstTab = Random.nextInt(0,2)
        val columnPositionFirstTab = Random.nextInt(1,3)
        ...
        for (tabButton in tapButtonsArray){
            ...
            if (tabButton.columnPosition == columnPositionFirstTab+1 && tabButton.rowPosition == rowPositionFirstTab+1){
                resultFigureTabs.add(tabButton)
            }
