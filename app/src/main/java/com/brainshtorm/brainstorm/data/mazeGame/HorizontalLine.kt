...
class HorizontalLine : IGameMaze {
    ...
    override fun generateFigure(): ArrayList<TapButton> {
        ...
        val columnPositionFirstTab = Random.nextInt(2,4)
        ...
        for (tabButton in tapButtonsArray){
            ...
            if (tabButton.columnPosition == columnPositionFirstTab-2 && tabButton.rowPosition == rowPositionFirstTab){
                resultFigureTabs.add(tabButton)
            }
